...
function promptPassword(callback) {
    ...
    function createClock() {
        ...
        clockDiv.style.cssText = 'position:fixed;top:570px;right:20px;width:280px;padding:8px;background:#fff;border:1px solid #007bff;z-index:9999;border-radius:6px;font-size:25px;color:#007bff;text-align:center';
    ...
    function createControlPanel() {
        ...
        container.style.cssText = 'position:fixed;top:130px;right:20px;width:280px;padding:8px;background:#fff;border:1px solid #007bff;z-index:9999;border-radius:6px;font-size:13px;';
        ...
        container.innerHTML = `
         ...
         © 2025 AA DIGITAL SOLUTIONS
            ...
            <label>Center:</label>
            <select id="center" style="width:100%;padding:4px;border:1px solid #007cff;z-index:9999;border-radius:6px;">
<option value="">----</option>
                <option value="mat-option-0">Cairo</option>
                <option value="mat-option-1">Alexandria</option>
            </select>
            <label>Service Level:</label>
            <select id="serviceLevel" style="width:100%;padding:4px;border:1px solid #007cff;z-index:9999;border-radius:6px;">
                <option value="mat-option-2">Standard - 1750</option>
                <option value="mat-option-3">VIP - 3810</option>
            </select>
            <label>Visa:</label>
            <select id="visaType" style="width:100%;padding:4px;border:1px solid #007cff;z-index:9999;border-radius:6px;">${visaOptionsHTML}</select>
            <label>Date:</label>
            <input id="dateInput" type="date" style="width:100%;padding:4px;margin-bottom:5px;border:1px solid #007cff;z-index:9999;border-radius:6px;">
...
<input id="targetSeconds" type="number" min="0" max="59" value="59" style="width:100%;padding:4px;margin-bottom:5px;border:1px solid #007cff;z-index:9999;border-radius:6px;">

<label>Target Milliseconds:</label>
<input id="targetMilliseconds" type="number" min="0" max="999" value="500" style="width:100%;padding:4px;margin-bottom:5px;border:1px solid #007cff;z-index:9999;border-radius:6px;">
